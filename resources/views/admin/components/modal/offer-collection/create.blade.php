    ...
    <div class="col-lg-12">
        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
            <div class="modal-dialog">
                <form method="post" id="offerCollectionForm" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="col-lg-6">
                                        <div class="category-save-text">
                                            <button type="submit" name="action" value="publish"><i
                                                    ...
                                                    id="addOfferCollection"></i>@lang('backend.Add Item')
                                                        ...
                                                        <div>
                                                            <div class="form-group general-form mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="title" id="title"
                                                                    placeholder="Ex: Sale Summer" required="" />
                                                            </div>
                                                            @error('title')
                                                        ...
                                                        <div>
                                                            <div class="form-group general-form mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    placeholder="Ex: The best offer" required="" />
                                                            </div>
                                                            @error('sub_title')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
