                                        ...
                                        <div class="col-md-12 grid-margin stretch-card">
                                            <div class="card">
                                                <div class="card-body custom-card-body">
                                                    ...
                                                    <form method="post"
                                                        action="{{ route('admin.offer.collection.update', $offer->id) }}"
                                                                        ...
                                                                        <div class="col-lg-12 ">
                                                                            <div class="product-input">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        @foreach ($products as $product)
                                                                                                            <option
                                                                                                                value="{{ $product->id }}"
                                                                                                                @if (in_array($product->id, $selectedProduct_ids)) selected @endif>
                                                                                ...
                                                                                <button type="submit "
                                                                                    ...
                                                                                    value="publish">@lang('backend.Update Item')
