...
<div class="container">
    ...
    <form action="{{ route('admin.privacy-policy.update', $privacyPolicy->slug) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <textarea name="content" rows="30" cols="50" class="form-control" id="description">{{ $privacyPolicy->content }}</textarea>
            @error('content')
            <div class="text-danger">{{$message}}</div>
            @enderror
        </div>
