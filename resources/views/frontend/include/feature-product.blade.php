<div class="u-s-p-y-60 pt-0 pb-2">
                ...
                <div class="col-lg-12">
                    <div class="section__text-wrap">
                        <h1 class="section__heading u-c-secondary u-s-m-b-12">
                            @lang('frontend.FEATURED PRODUCTS')
                        </h1>
    ...
    <div class="section__content">
        <div class="container">
            <div class="row custom-row" id="featuredproduct">
                @foreach ($feature as $product)
                    @if (count($product->productvariations) > 0)
                        <div class="col-xl-2 col-lg-3 col-md-5 col-6 u-s-m-b-30 custom-padding">
                                        ...
                                        <ul class="product-o__action-list">
                                            <li>
                                                <a data-modal="modal" data-product="{{ json_encode($product) }}"
                                                    class="QuickLook" data-tooltip="tooltip" data-placement="top"
                                                    title="@lang('frontend.Quick View')"><i class="fas fa-search-plus"></i></a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a class="addWishlist"
                                                    ...
                                                    data-id="{{ $product->id }}"
                                                    href="{{ route('user.wishlist.page') }}" data-tooltip="tooltip"
