          ...
          <div class="col-lg-4 col-md-6">
            <div class="outer-footer__content u-s-m-b-40">
              ...
              <div class="outer-footer__social">
                <ul>
                  <li>
                    <a class="s-fb--color-hover" href="{{$basic_setting->facebook}}"
                      ><i class="fab fa-facebook-f"></i
                    ></a>
                  </li>
                  <li>
                    <a class="s-tw--color-hover" href="{{$basic_setting->twitter}}"
                      ><i class="fab fa-twitter"></i
                    ></a>
                  </li>
                  <li>
                    <a class="s-youtube--color-hover" href="{{$basic_setting->youtube}}"
                  ...
                  <li>
                    <a class="s-gplus--color-hover" href="{{$basic_setting->google}}"
                ...
                <div class="outer-footer__content u-s-m-b-40">
                  ...
                  <div class="outer-footer__list-wrap">
                    <ul>
                      ...
                      <li>
                        <a href="shop.html">Manufacturer</a>
                      </li>
                      <li>
